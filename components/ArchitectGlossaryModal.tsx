        ...
        <div className="p-3 sm:p-4 bg-white dark:bg-slate-850 border-b-2 border-[#1f2937] dark:border-slate-700 space-y-3 shrink-0">
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            <button
              ...
              className={`px-3 py-2 rounded-xl text-xs font-extrabold flex items-center gap-1.5 transition cursor-pointer ${
                filterBookmarkedOnly
                  ? 'bg-amber-100 dark:bg-amber-950/80 text-amber-600 dark:text-amber-400 font-extrabold'
