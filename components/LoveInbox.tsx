...
function renderBackpackIconSVG(className = 'w-5 h-5') {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2.5}>
      <rect x="4" y="8" width="16" height="13" rx="4" fill="currentColor" fillOpacity="0.15" />
  ...
  return (
    <div className={`border-4 rounded-2xl shadow-[4px_4px_0px_#1f2937] p-4 sm:p-6 max-w-2xl mx-auto my-4 transition-colors ${
      ...
      <div className="flex border-b-2 border-[#1f2937] mb-6">
        ...
        >
          {renderBackpackIconSVG(activeTab === 'wallet' ? 'text-amber-500 w-5 h-5' : 'w-5 h-5')}
          ...
          <div className="bg-white border-2 border-[#1f2937] p-4 rounded-xl shadow-[3px_3px_0px_#1f2937] space-y-3">
            <h3 className="text-sm font-serif font-black text-[#1f2937] flex items-center justify-between border-b-2 border-dashed border-[#1f2937] pb-2">
              <span className="flex items-center gap-1.5">
                {renderBackpackIconSVG('w-4 h-4 text-amber-600')}
