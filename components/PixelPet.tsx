...
export const PixelPet: React.FC<PixelPetProps> = ({
  ...
  return (
    <div className="fixed bottom-[calc(54px+env(safe-area-inset-bottom,0px))] md:bottom-2 left-0 right-0 z-40 select-none pointer-events-none w-full h-32 overflow-visible">
