...
export const ORDERS: Order[] = [
  ...
  },
  {
    id: 3,
    level: 1,
    customerName: 'Gấu Trúc Nho Nhã',
    customerSprite: 'panda',
  ...
  },
  {
    id: 5,
    level: 2,
    customerName: 'Chị Vy Đồng Nghiệp',
    customerSprite: 'girl',
    ...
    targetIngredients: ['绿tea' /* 绿茶 */, '绿茶', '椰果', '少糖', '少冰'],
    // Filtered helper to ensure robust check
